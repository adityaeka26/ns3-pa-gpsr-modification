...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Werror', '-Wall', '-std=c++0x', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
EXAMPLE_DIRECTORIES = ['realtime', 'error-model', 'energy', 'socket', 'wireless', 'naming', 'routing', 'ipv6', 'tutorial', 'tcp', 'stats', 'udp', 'matrix-topology', 'udp-client-server']
...
LINKFLAGS_PYEMBED = ['-Wl,-rpath,/root/.pyenv/versions/2.7.18/lib']
LINKFLAGS_PYEXT = ['-Wl,-rpath,/root/.pyenv/versions/2.7.18/lib', '-Wl,-rpath,/root/.pyenv/versions/2.7.18/lib']
...
NS3_ENABLED_MODULES = ['ns3-antenna', 'ns3-aodv', 'ns3-applications', 'ns3-bridge', 'ns3-buildings', 'ns3-config-store', 'ns3-core', 'ns3-csma', 'ns3-csma-layout', 'ns3-dsdv', 'ns3-dsr', 'ns3-energy', 'ns3-fd-net-device', 'ns3-flow-monitor', 'ns3-gpsr', 'ns3-internet', 'ns3-location-service', 'ns3-lr-wpan', 'ns3-lte', 'ns3-mesh', 'ns3-mmgpsr', 'ns3-mobility', 'ns3-mpi', 'ns3-netanim', 'ns3-network', 'ns3-nix-vector-routing', 'ns3-olsr', 'ns3-pagpsr', 'ns3-point-to-point', 'ns3-point-to-point-layout', 'ns3-propagation', 'ns3-sixlowpan', 'ns3-spectrum', 'ns3-stats', 'ns3-tap-bridge', 'ns3-test', 'ns3-topology-read', 'ns3-uan', 'ns3-virtual-net-device', 'ns3-wave', 'ns3-wifi', 'ns3-wimax']
NS3_EXECUTABLE_PATH = ['/root/downloads/ns3-pa-gpsr-modification/ns-3.23/build/src/fd-net-device', '/root/downloads/ns3-pa-gpsr-modification/ns-3.23/build/src/tap-bridge']
NS3_MODULES = ['ns3-antenna', 'ns3-aodv', 'ns3-applications', 'ns3-bridge', 'ns3-buildings', 'ns3-config-store', 'ns3-core', 'ns3-csma', 'ns3-csma-layout', 'ns3-dsdv', 'ns3-dsr', 'ns3-energy', 'ns3-fd-net-device', 'ns3-flow-monitor', 'ns3-gpsr', 'ns3-internet', 'ns3-location-service', 'ns3-lr-wpan', 'ns3-lte', 'ns3-mesh', 'ns3-mmgpsr', 'ns3-mobility', 'ns3-mpi', 'ns3-netanim', 'ns3-network', 'ns3-nix-vector-routing', 'ns3-olsr', 'ns3-pagpsr', 'ns3-point-to-point', 'ns3-point-to-point-layout', 'ns3-propagation', 'ns3-sixlowpan', 'ns3-spectrum', 'ns3-stats', 'ns3-tap-bridge', 'ns3-test', 'ns3-topology-read', 'ns3-uan', 'ns3-virtual-net-device', 'ns3-wave', 'ns3-wifi', 'ns3-wimax']
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/11', '/root/downloads/ns3-pa-gpsr-modification/ns-3.23/build']
...
VERSION = '3.23'
WITH_PYBINDGEN = '/root/downloads/ns3-pa-gpsr-modification/pybindgen-0.17.0.886'
WL_SONAME_SUPPORTED = True
cfg_files = ['/root/downloads/ns3-pa-gpsr-modification/ns-3.23/build/ns3/config-store-config.h', '/root/downloads/ns3-pa-gpsr-modification/ns-3.23/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
